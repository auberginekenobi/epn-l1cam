...
## Table of contents
### hpc-scripts
Scripts developed to preprocess RNA-seq data according to the pipeline  
`fastp -> STAR -> RSEM`.  
These were designed to run on the SHIROKANE supercomputer at the U. Tokyo Human Genome Center.
